...
func (r *Router) Handler(ctx context.Context) http.Handler {
	...
	mux.HandleFunc("PATCH "+bp+"/api/v1/auth/tokens/{id}/archive", wrapAuth(r.handleArchiveAPIToken, authMw))
	mux.HandleFunc("PATCH "+bp+"/api/v1/auth/tokens/{id}/unarchive", wrapAuth(r.handleUnarchiveAPIToken, authMw))
