...
func (r *Router) Handler(ctx context.Context) http.Handler {
	...
	mux.HandleFunc("GET "+bp+"/api/v1/reports/health/tiers", wrapAuth(r.handleReportHealthTiers, authMw))
	...
	mux.HandleFunc("GET "+bp+"/settings/{section}", wrapOptionalAuth(r.handleSettingsSectionPage, optAuthMw))
