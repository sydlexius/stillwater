...
-- internal/rule/service.go), which refuses to run the DELETE for an
-- event-driven rule with surviving violations. The schema itself cannot
...
INSERT OR IGNORE INTO settings (key, value) VALUES
    ...
    ('provider.priority.born',         '["musicbrainz","wikidata","wikipedia"]'),
    ('provider.priority.died',         '["musicbrainz","wikidata","wikipedia"]'),
    ('provider.priority.disbanded',    '["musicbrainz","wikidata","wikipedia"]'),
    ('provider.priority.years_active', '["wikipedia","audiodb","musicbrainz"]'),
    ('provider.priority.type',         '["musicbrainz","wikidata","discogs"]'),
    ('provider.priority.gender',       '["musicbrainz","wikidata"]'),
    ('provider.priority.origin',       '["wikipedia","audiodb","wikidata","musicbrainz"]'),
