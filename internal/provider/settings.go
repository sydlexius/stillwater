...
func DefaultPriorities() []FieldPriority {
	return []FieldPriority{
		...
		{Field: "gender", Providers: []ProviderName{NameMusicBrainz, NameAudioDB}},
		{Field: "years_active", Providers: []ProviderName{NameWikipedia}},
		{Field: "formed", Providers: []ProviderName{NameMusicBrainz, NameWikidata, NameAudioDB}},
		{Field: "disbanded", Providers: []ProviderName{NameMusicBrainz, NameWikidata, NameAudioDB}},
		{Field: "born", Providers: []ProviderName{NameMusicBrainz, NameAudioDB}},
		{Field: "died", Providers: []ProviderName{NameMusicBrainz, NameAudioDB}},
		{Field: "country", Providers: []ProviderName{NameMusicBrainz, NameWikidata, NameWikipedia, NameAudioDB}},
