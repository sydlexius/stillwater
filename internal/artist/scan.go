...
const artistColumns = `id, name, sort_name, type, gender, country, disambiguation,
	genres, styles, moods,
...
func (s *scannedArtist) scanPtrs() []any {
	return []any{
		&s.a.ID, &s.a.Name, &s.a.SortName, &s.a.Type, &s.a.Gender, &s.a.Country, &s.a.Disambiguation,
