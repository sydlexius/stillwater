...
func ImageUpload(artistID string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "\" hx-target=\"#upload-result\" hx-swap=\"innerHTML\" hx-indicator=\"#upload-spinner\" class=\"flex gap-2\"><input type=\"hidden\" name=\"type\" value=\"thumb\" id=\"fetch-type\"> <input type=\"url\" name=\"url\" placeholder=\"https://example.com/image.jpg\" class=\"flex-1 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500\" required> <button type=\"submit\" class=\"px-4 py-2 text-sm rounded-md bg-green-600 text-white hover:bg-green-700 transition-colors\">Fetch</button></form></div><div id=\"upload-spinner\" class=\"htmx-indicator text-center py-2\"><span class=\"text-sm text-gray-500 dark:text-gray-400\">Processing...</span></div><div id=\"upload-result\"></div></div></section>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
