...
func settingsUsersTab(data UsersTabData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if data.MultiUserEnabled {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 38, "</div><div id=\"users-bulk-bar\" class=\"hidden items-center gap-2\"><span id=\"users-bulk-count\" class=\"text-xs text-gray-500 dark:text-gray-400\" role=\"status\" aria-live=\"polite\" aria-atomic=\"true\"></span> <button type=\"button\" id=\"users-bulk-delete-btn\" class=\"text-xs px-3 py-1.5 rounded bg-red-600 text-white hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors\" disabled onclick=\"openBulkDeleteDialog()\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
