...
func dashActionRovingItem(v rule.RuleViolation, basePath string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var114, templ_7745c5c3_Err = templ.JoinURLErrs(templ.SafeURL(basePath + "/next/artists/" + v.ArtistID))
		if templ_7745c5c3_Err != nil {
...
func DashboardActivityRowNext(c artist.MetadataChangeWithArtist, basePath string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if c.ArtistID != "" {
			...
			templ_7745c5c3_Var127, templ_7745c5c3_Err = templ.JoinURLErrs(templ.SafeURL(basePath + "/next/artists/" + c.ArtistID))
			if templ_7745c5c3_Err != nil {
