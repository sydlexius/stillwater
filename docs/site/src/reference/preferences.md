...
| <a id="pref-show_platform_debug"></a>`show_platform_debug` | Show Platform Debug Tab | `false` | `true`, `false` | Add a Debug tab to each artist page showing the raw API payload from connected platforms. |
